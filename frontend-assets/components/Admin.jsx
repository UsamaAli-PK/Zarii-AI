        ...
        <div style={{ maxHeight: 360, overflow: "auto", padding: 8 }}>
          {filt.map((t) => (
            <button
              ...
              onMouseEnter={(e) =>
                (e.currentTarget.style.background = "#F1F7E9")
              }
              onMouseLeave={(e) =>
            ...
            >
              ...
              {t.label}
              <span
                style={{ marginLeft: "auto", fontSize: 11, color: "#7E7E7E" }}
              >
                {t.group}
              </span>
            </button>
...
const Card = ({ children, style, ...r }) => (
  <div
    style={{
      ...
      borderRadius: 14,
      border: "1px solid #E6E0D1",
      boxShadow: "0 1px 2px rgba(31,74,44,0.04)",
      ...style,
    }}
    {...r}
  >
...
const Stat = ({
  ...
  <Card style={{ padding: 18 }}>
    <div style={{ display: "flex", justifyContent: "space-between" }}>
      ...
      {delta && (
        <span
          className={"tag " + (deltaType === "up" ? "tag-green" : "tag-red")}
          style={{ fontSize: 11 }}
        >
          {delta}
        </span>
...
const AdminTopbar = ({
  ...
  const titles = {
    overview: [
      "Overview",
      "Live snapshot of ZARii AI · last refreshed just now",
    ],
    users: ["Users", "All farmers across web app and WhatsApp"],
    diagnoses: [
      "Diagnoses & quality",
      "Every scan, with confidence and feedback",
    ],
    outbreaks: [
      "Outbreak intelligence",
      "Regional disease pressure across Pakistan",
    ],
    whatsapp: [
      "WhatsApp operations",
      "Live conversations, templates, takeover",
    ],
    sponsors: [
      "Sponsors & Ads",
      "Sponsor companies, boosted products, performance",
    ],
  ...
  return (
    ...
    >
      <div>
        ...
        <div style={{ fontSize: 12.5, color: "#7E7E7E", marginTop: 2 }}>
          {sub}
        </div>
      </div>
      <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
        ...
        >
          <button
            ...
            style={{
              ...
              fontWeight: 600,
              border: "none",
              background: demoMode ? "#fff" : "transparent",
              color: demoMode ? "#1F4A2C" : "#7E7E7E",
              boxShadow: demoMode ? "0 1px 2px rgba(0,0,0,0.06)" : "none",
            }}
          >
            Demo
          </button>
          <button
            ...
            style={{
              ...
              fontWeight: 600,
              border: "none",
              background: !demoMode ? "#2E6B3F" : "transparent",
              color: !demoMode ? "#fff" : "#7E7E7E",
              boxShadow: !demoMode ? "0 1px 2px rgba(0,0,0,0.06)" : "none",
            }}
          >
            Live
        ...
        <button
          ...
          title={`Logout (${admin?.email || "Admin"})`}
        >
          {admin?.name
            ? admin.name
                .split(" ")
...
const AdminConsole = ({ navigate, onLogout, admin }) => {
  ...
  const [demoMode, setDemoMode] = useS_Adm(false);
  ...
  useE_Adm(() => {
    console.log("[Admin] useEffect triggered, demoMode:", demoMode);
    if (!demoMode) {
      console.log("[Admin] Calling fetchRealData");
      fetchRealData();
    }
  }, [demoMode]);

  const fetchRealData = async () => {
    console.log("[Admin] fetchRealData called");
    setLiveError(null);
    try {
      ...
      console.log("[Admin] API Results:", {
        overview: ovRes.status,
        users: usersRes.status,
        diagnoses: diagRes.status,
        outbreaks: outbreaksRes.status,
        advisories: advisoriesRes.status,
        waQueue: waQueueRes.status,
        sponsors: sponsorsRes.status,
        sponsored: sponsoredRes.status,
        revenue: revenueRes.status,
        catalog: catalogRes.status,
        apiKeys: apiKeysRes.status,
        team: teamRes.status,
        audit: auditRes.status,
      });
      if (ovRes.status === "rejected")
        console.error("[Admin] Overview error:", ovRes.reason);
      ...
      if (failedCount > 0)
        setLiveError(
          `${failedCount} data source(s) failed to load. Some sections may be incomplete.`,
        );
        ...
        outbreaks:
          outbreaksRes.status === "fulfilled"
            ? {
                ...outbreaksData,
                advisories:
                  outbreaksData.advisories || advisoriesData.advisories || [],
              }
            : null,
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 11, color: "#9DCB7C" }}>
                Owner · Operator view
              </div>
            </div>
          </div>
              ...
              .map((t) => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 8,
                    background:
                      tab === t.id ? "rgba(102,166,79,0.18)" : "transparent",
                ...
                >
                  ...
                  <Icon
                    name={t.icon}
                    size={16}
                    color={tab === t.id ? "#9DCB7C" : "rgba(255,255,255,0.55)"}
                  />
                  {t.label}
                </button>
              ))}
      ...
      <main style={{ flex: 1, minWidth: 0, overflow: "auto" }}>
        ...
        {liveError && !demoMode && (
          ...
          >
            ...
            <span style={{ color: "#D04E2C", fontWeight: 600 }}>
              {liveError}
            </span>
            <button
        ...
        <div style={{ padding: "20px 32px 60px" }}>
          {tab === "overview" && (
            <Overview
              demoMode={demoMode}
              data={demoMode ? null : realData.overview}
            />
          )}
          {tab === "users" && (
            <UsersTable
              demoMode={demoMode}
              data={demoMode ? null : realData.users}
            />
          )}
          {tab === "diagnoses" && (
            <DiagnosesTab
              demoMode={demoMode}
              data={demoMode ? null : realData.diagnoses}
            />
          )}
          {tab === "outbreaks" && (
            <OutbreaksTab
              demoMode={demoMode}
              data={demoMode ? null : realData.outbreaks}
            />
          )}
          {tab === "whatsapp" && (
            <WhatsAppOps
              demoMode={demoMode}
              data={demoMode ? null : realData.waQueue}
            />
          )}
          {tab === "sponsors" && (
            <SponsorsTab
              ...
              data={
                demoMode
                  ...
                  : {
                      ...
                      sponsoredProducts: realData.sponsoredProducts,
                    }
              }
            />
          )}
          {tab === "revenue" && (
            <RevenueTab
              demoMode={demoMode}
              data={demoMode ? null : realData.revenue}
            />
          )}
          {tab === "catalog" && (
            <CatalogTab
              demoMode={demoMode}
              data={demoMode ? null : realData.catalog}
            />
          )}
          {tab === "api" && (
            <ApiKeysTab
              demoMode={demoMode}
              data={demoMode ? null : realData.apiKeys}
          ...
          {tab === "team" && (
            <TeamTab
              demoMode={demoMode}
              data={demoMode ? null : realData.team}
            />
          )}
        </div>
      </main>
...
const Overview = ({ demoMode, data }) => {
  ...
  const healthRows =
    demoMode || liveHealth.length === 0 ? demoHealth : liveHealth;
  const demoFeed = [
    {
      user: "Aslam, Multan",
      region: "Punjab",
    ...
    <div>
      ...
      >
        <Stat
          ...
          value={demoMode ? "14,328" : (kpis?.dau?.toLocaleString() ?? "—")}
          delta="+8.2%"
          icon="users"
          color="#2E6B3F"
          sub="vs. yesterday"
        ...
        <Stat
          label="Scans today"
          value={
            demoMode ? "3,210" : (kpis?.scans_today?.toLocaleString() ?? "—")
          }
          delta="+12%"
          icon="camera"
          color="#66A64F"
          sub="9.4× peak this hour"
        />
        <Stat
          label="Diagnoses · 7d"
          value={
            demoMode ? "42,180" : (kpis?.scans_7d?.toLocaleString() ?? "—")
          }
          delta="+18%"
          icon="flask"
          color="#F4A62A"
      ...
      >
        <Card style={{ padding: 22 }}>
          ...
          <svg viewBox="0 0 600 200" style={{ width: "100%", height: 200 }}>
            ...
            <path
              d="M40 130 L120 110 L200 80 L280 90 L360 60 L440 50 L520 35 L590 45 L590 180 L40 180 Z"
              fill="url(#ovGrad)"
            />
            <path
              d="M40 130 L120 110 L200 80 L280 90 L360 60 L440 50 L520 35 L590 45"
              stroke="#66A64F"
              strokeWidth="2.5"
              fill="none"
              strokeLinecap="round"
          ...
          {healthRows.map((s, i) => (
            <div
              ...
              style={{
                ...
                justifyContent: "space-between",
                padding: "8px 0",
                borderTop: i > 0 ? "1px solid #F1ECDD" : "none",
              }}
            >
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <span
                  style={{
                    ...
                    boxShadow:
                      "0 0 0 3px " +
                      (s.status === "healthy"
                        ? "rgba(102,166,79,0.18)"
                        : "rgba(244,166,42,0.18)"),
                  }}
                />
                <span
                  style={{ fontSize: 13.5, fontWeight: 600, color: "#1F4A2C" }}
                >
                  {s.provider || s.name}
                </span>
              </div>
              <div style={{ fontSize: 12, color: "#7E7E7E" }}>
                {s.latency ? s.latency + "ms" : s.lat} ·{" "}
                {s.calls_today?.toLocaleString() ?? 0} calls
              </div>
            </div>
          ))}
        </Card>
      ...
      >
        <Card style={{ padding: 22 }}>
          ...
          {[
            {
              sev: "high",
              text: "Whitefly query spike: Bahawalpur +312% in 4h",
              when: "23m ago",
            },
            {
              sev: "med",
              text: "TTS latency p95 above 2s SLO for 18m",
              when: "1h ago",
            },
            {
              sev: "low",
              text: 'New disease class detected: 14 unmatched scans tagged "leaf curl"',
              when: "3h ago",
            },
            {
              sev: "med",
              text: "Sponsor budget at 84% for Bayer · Antracol — review pacing",
              when: "5h ago",
            },
          ].map((a, i) => (
            <div
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                <div
                  style={{ fontSize: 13.5, color: "#1F4A2C", fontWeight: 500 }}
                >
                  {a.text}
                </div>
                <div style={{ fontSize: 11.5, color: "#7E7E7E", marginTop: 2 }}>
                  {a.when}
                </div>
              </div>
        ...
        <Card style={{ padding: 22 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {feedRows.length === 0 ? (
              <div style={{ color: "#7E7E7E", fontSize: 13 }}>
                No recent activity.
              </div>
            ) : (
              feedRows.map((a, i) => (
                ...
                >
                  ...
                  />
                  <span style={{ fontWeight: 600, color: "#1F4A2C" }}>
                    {a.user}
                    {a.region && a.user !== a.region ? ", " + a.region : ""}
                  </span>
                  <span style={{ color: "#5A5A5A" }}>
                    {a.crop} · {a.disease || a.what}
                  </span>
                  <span
                    style={{
                      marginLeft: "auto",
      ...
      >
        ...
        />
        <Stat
          label="Sponsored impressions · 7d"
          value="184k"
          delta="+15%"
          icon="trend"
          color="#9DCB7C"
...
const UsersTable = ({ demoMode, data }) => {
  ...
  const displayUsers = demoMode
    ...
    : rawUsers.map((u) => ({
        ...
        lastSeen: u.last_scan
          ? new Date(u.last_scan).toLocaleDateString()
          : "—",
  ...
  const filtered = displayUsers.filter(
    (u) =>
      ...
      (region === "all" || u.region.includes(region)),
  );
  ...
  return (
    <div>
      ...
      >
          ...
          value={
            demoMode
              ...
              : (summary?.total?.toLocaleString() ??
                rawUsers.length.toLocaleString())
          }
        ...
        <Stat
          label="WAU"
          value={demoMode ? "68,440" : (summary?.wau?.toLocaleString() ?? "—")}
          delta="+5.4%"
          icon="trend"
          color="#66A64F"
        />
      ...
      <Card>
        ...
        >
          ...
          <div style={{ marginLeft: "auto", fontSize: 12, color: "#7E7E7E" }}>
                ...
                <tr key={i} style={{ borderBottom: "1px solid #F4F1E5" }}>
                  <td style={{ padding: "12px 14px" }}>
                    ...
                    >
                      ...
                      <div>
                        <div style={{ fontWeight: 600, color: "#1F4A2C" }}>
                          {u.name}
                        </div>
                  ...
                  <td style={{ padding: "12px 14px", color: "#5A5A5A" }}>
                    {u.region}
                  </td>
                  <td style={{ padding: "12px 14px", color: "#5A5A5A" }}>
                    {u.crops}
                  ...
                  <td style={{ padding: "12px 14px" }}>
                    <Pill tone="gray">{u.lang.toUpperCase()}</Pill>
                  </td>
                  <td style={{ padding: "12px 14px", color: "#5A5A5A" }}>
                    {u.cohort}
                  </td>
...
const DiagnosesTab = ({ demoMode, data }) => {
  ...
  const displayScans = demoMode
    ...
    : rawScans.map((s) => ({
        ...
        fb:
          s.user_feedback === "positive"
            ? "👍"
            : s.user_feedback === "negative"
              ? "👎"
              : "?",
    ...
    <div>
      ...
      >
        <Stat
          ...
          value={demoMode ? "3,210" : (summary?.today?.toLocaleString() ?? "—")}
          delta="+12%"
          icon="flask"
          color="#2E6B3F"
        />
        ...
        <Stat
          ...
          value={
            demoMode ? "42" : (summary?.flagged_queue?.toLocaleString() ?? "—")
          }
          delta="-8"
          deltaType="down"
          icon="bell"
          color="#F4A62A"
          sub="awaiting agronomist"
        />
        <Stat
          label="User feedback +ve"
          value={
            demoMode
              ? "91%"
      ...
      >
        <Card style={{ padding: 22 }}>
          ...
          <svg viewBox="0 0 600 200" style={{ width: "100%", height: 200 }}>
            ...
            <path
              d="M40 80 L100 75 L160 70 L220 65 L280 62 L340 55 L400 50 L460 48 L520 42 L590 38"
              stroke="#66A64F"
              strokeWidth="2.5"
              fill="none"
              strokeLinecap="round"
            />
            <path
              d="M40 110 L100 105 L160 100 L220 92 L280 88 L340 80 L400 78 L460 72 L520 70 L590 68"
              stroke="#F4A62A"
              strokeWidth="2.5"
              fill="none"
              strokeLinecap="round"
        ...
        <Card style={{ padding: 22 }}>
          ...
          {[
            ...
            >
              <div style={{ fontSize: 13, color: "#1F4A2C" }}>
                {p.a} <span style={{ color: "#7E7E7E" }}>↔</span> {p.b}
              </div>
      ...
      <Card>
        ...
        >
          ...
          <div style={{ display: "flex", gap: 4, marginLeft: 16 }}>
            {["All", "Flagged", "Low confidence", "Negative feedback"].map(
              (t, i) => (
                <button
                  key={i}
                  style={{
                    ...
                    fontWeight: 600,
                    borderRadius: 99,
                    background: i === 0 ? "#1F4A2C" : "transparent",
          ...
          <tbody>
            {displayScans.length === 0 && (
              <tr>
                <td
                  colSpan="11"
                  style={{ padding: 24, textAlign: "center", color: "#7E7E7E" }}
                >
                  No diagnoses yet.
                </td>
              </tr>
            ...
            {displayScans.map((s, i) => (
              <tr
                key={i}
                style={{
                  borderBottom: "1px solid #F4F1E5",
                  background: s.flag ? "#FFFCF1" : "transparent",
                }}
              >
                <td style={{ padding: "12px 14px" }}>
                  <input type="checkbox" />
                ...
                <td style={{ padding: "12px 14px" }}>
                  <div
                    style={{
                      ...
                      height: 38,
                      borderRadius: 8,
                      background: "linear-gradient(135deg, #4a7c3a, #2E6B3F)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                    }}
...
const OutbreaksTab = ({ demoMode, data }) => {
  ...
  const demoOutbreaks = [
    ...
    {
      region: "Sukkur",
      issue: "Bacterial Leaf Blight · Rice",
      trend: "+12%",
      cases: "95 farms",
      sev: "low",
    },
  ...
  const demoAdvisories = [
    {
      title: "Whitefly preventive spray · Cotton belt",
      regions: "Multan, Bahawalpur, Sahiwal",
      sent: "2d ago",
      reach: "124,000",
      engaged: "38%",
      status: "Active",
    ...
    {
      title: "Yellow Rust early warning · Wheat",
      regions: "Faisalabad, Sialkot",
      sent: "5d ago",
      reach: "88,000",
      engaged: "42%",
      status: "Active",
    ...
    {
      title: "Mango anthracnose seasonal alert",
      regions: "Hyderabad, Sukkur",
      sent: "12d ago",
      reach: "34,000",
      engaged: "29%",
      status: "Closed",
  ...
  const liveOutbreaks = (data?.outbreaks || []).map((o) => ({
    ...
    trend:
      o.trend_pct != null
        ? (o.trend_pct >= 0 ? "+" : "") + o.trend_pct + "%"
        : "—",
    cases:
      o.farm_count != null ? o.farm_count.toLocaleString() + " farms" : "—",
    ...
    <div>
      ...
      >
        <Stat
          ...
          value={
            demoMode
              ? "14"
              : (outSummary?.active_outbreaks?.toLocaleString() ??
                liveOutbreaks.length.toLocaleString())
          }
          delta="+3"
          icon="bell"
          color="#D04E2C"
        />
        <Stat
          label="Districts on alert"
          value={
            demoMode
              ? "22"
              : (outSummary?.districts_on_alert?.toLocaleString() ?? "—")
          }
          delta="+5"
          icon="pin"
          color="#F4A62A"
        />
        <Stat
          label="Advisories sent · 7d"
          value={
            demoMode
              ? "6"
              : (outSummary?.advisories_sent_7d?.toLocaleString() ??
                liveAdvisories.length.toLocaleString())
          }
          icon="bell"
          color="#2E6B3F"
        />
        <Stat
          ...
          value={
            demoMode
              ? "84k farmers"
              : outSummary?.avg_reach
                ? outSummary.avg_reach.toLocaleString() + " farmers"
                : "—"
          }
          icon="users"
          color="#66A64F"
        ...
        >
          ...
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            ...
            >
              ...
              <option>Yellow Rust</option>
              <option>Anthracnose</option>
            </select>
        ...
        >
          ...
          >
            ...
            <div style={{ marginTop: 16 }}>
              ...
              <input
                ...
                style={{ width: "100%", accentColor: "#2E6B3F" }}
              />
              <div
                style={{
                  display: "flex",
          ...
          <div>
            ...
            {displayOutbreaks.length === 0 ? (
              <div
                style={{ padding: "20px 0", color: "#7E7E7E", fontSize: 13 }}
              >
                No outbreak data yet.
              </div>
            ) : (
      ...
      <Card style={{ padding: 22 }}>
        ...
        {displayAdvisories.length === 0 ? (
          <div style={{ padding: "20px 0", color: "#7E7E7E", fontSize: 13 }}>
          ...
          displayAdvisories.map((a, i) => (
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                <div
                  style={{ fontSize: 14, fontWeight: 600, color: "#1F4A2C" }}
                >
                  {a.title}
                </div>
                <div style={{ fontSize: 12, color: "#7E7E7E" }}>
                  {a.regions} · sent {a.sent}
                </div>
              </div>
              <div
                style={{ fontSize: 12, color: "#5A5A5A", textAlign: "right" }}
              >
                <div>{a.reach} reached</div>
                <div style={{ color: "#66A64F", fontWeight: 600 }}>
                  {a.engaged} engaged
                </div>
              </div>
              <Pill tone={a.status === "Active" ? "green" : "gray"}>
                {a.status}
              </Pill>
            </div>
          ))
