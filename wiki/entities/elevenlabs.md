...
ElevenLabs provides both speech-to-text (STT) and text-to-speech (TTS) for the [[urdu-voice-assistant]].

## Current Implementation (May 2026)

| Service | Model | Status |
|---------|-------|--------|
| STT (Speech to Text) | Scribe v2 | ✅ Implemented |
| TTS (Text to Speech) | eleven_multilingual_v2 | ✅ Implemented |
...
- **Multilingual:** Supports 90+ languages including Urdu, Punjabi
- **Speech to Text:** Scribe v2 with high accuracy for agricultural queries
