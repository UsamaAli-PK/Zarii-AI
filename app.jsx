...
/* global Landing, Onboarding, AppShell, Dashboard, Analyze, Voice, History, Analytics, WhatsAppView, AdminConsole, AdminLogin */
...
const App = () => {
  ...
  useE_App(() => {
    ...
    const validScreens = ['landing', 'onboarding', 'dashboard', 'analyze', 'voice', 'history', 'analytics', 'whatsapp', 'admin'];
  ...
  const effectiveUser = user || { name: 'Muhammad Aslam', phone: '+92 300 1234567', lang: lang };
  const inApp = ['dashboard','analyze','voice','history','analytics','whatsapp'].includes(screen);
